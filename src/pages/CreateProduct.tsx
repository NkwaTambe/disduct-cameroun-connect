    ...
    const fetchUser = async () => {
      ...
      if (!user) {
        toast({
          ...
          description: "Vous devez être connecté pour vendre un article.",
          variant: "destructive",
        });
        navigate("/?auth=login");
      } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isFirstPost) {
        toast({
          title: "Félicitations !",
          description: "Votre premier article a été mis en ligne avec succès !",
        });
      } else {
        toast({
          title: "Succès",
          description: "Votre article a été mis en ligne.",
        });
      }
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Fournissez les détails pour aider les acheteurs à trouver votre
              article.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Ex: Douala, Bonaberi"
                />
              </div>
