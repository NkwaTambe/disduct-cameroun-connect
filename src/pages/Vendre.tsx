  ...
  const steps = [
    {
      ...
      description:
        "Créez votre compte vendeur en quelques minutes. Complétez votre profil pour inspirer confiance.",
    ...
    },
    {
      ...
      description:
        "Prenez des photos de qualité sous différents angles. Des photos attrayantes augmentent vos chances de vente.",
    },
    {
      icon: Upload,
      title: "3. Créez votre annonce",
      description:
        "Ajoutez vos articles en renseignant toutes les caractéristiques : titre, description, prix, etc.",
    ...
    },
    {
      ...
      description:
        "Utilisez notre système de chat intégré pour répondre aux questions et rassurer les acheteurs.",
    },
    {
      icon: DollarSign,
    ...
    },
    {
      ...
      description:
        "Une fois l'accord trouvé, confirmez la vente et préparez soigneusement votre article.",
    },
    {
      icon: Truck,
      title: "7. Suivez la livraison",
      description:
        "Confiez votre article à un livreur et suivez sa livraison en temps réel grâce à notre système intégré.",
    },
    {
      icon: Star,
      title: "8. Évaluez la transaction",
      description:
        "Après livraison, notez l'acheteur et laissez un commentaire pour aider la communauté.",
    },
  ];
      ...
      <section className="bg-gradient-hero text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button
            ...
            onClick={() => handleAction(() => navigate("/create-product"))}
          >
            Commencer à vendre
          </Button>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Suivez ces 8 étapes simples pour réussir vos ventes.
            </p>
          </div>
